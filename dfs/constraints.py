...
# class SingleGameConstraint(LineupConstraint):
#     """
#     # TODO
#     """
#
#     def __init__(self, t1: str, t2: str, team_col: str, num_players: int):
#         """
#
#         :param t1:
#         :param t2:
...
#         :return: An LpAffineExpression to be added to the LpProblem.
#         """
#         return lpSum(data[data[self.team_col].isin([self.t1, self.t2])]['LpVariable']) == self.num_players
#
#     def is_valid(self, constraints: List['LineupConstraint']) -> Tuple[bool, Optional[str]]:
#         """
#         Returns false if any of the below conditions are satisfied:
